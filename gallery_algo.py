...
# Specify the folder containing the images(489 items - typical Whatsapp Documents folder)
image_folder = r'C:\Users\nithy\OneDrive\Desktop\Automatic_File_Deletion\typical_gallery'  # Change this to your folder path
...
def standardize_text(text):
    replacements = {
        r'\b(moving|good a morning)\b': 'morning',  
...
search_phrases = ['Good Morning', 'good morning', 'morning', 'shine', 'awake', 'begin','happy','new year']
...
# Final summary
print(f'Total images deleted in all three stages: {matching_count_stage1 + matching_count_stage2 }')
print(f'Final ratio after three stages of deletion:', (matching_count_stage1 + matching_count_stage2 ) / total_images)

print('Remaining images count:',len(image_names)-(matching_count_stage1+matching_count_stage2))

end=time.time()

print('Running time of the algorithm',end-start)